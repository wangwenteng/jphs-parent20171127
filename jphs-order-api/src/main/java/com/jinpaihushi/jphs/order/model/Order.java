...
public class Order extends BaseModel implements Predicate<Order>, Updator<Order> {
	...
	public String toString() {
		return new StringBuilder().append("Order{").
			...
			append(",acceptUserId=").append(acceptUserId).
			append(",appointmentTime=").append(appointmentTime).
			append(",acceptTime=").append(acceptTime).
	 ...
	 * platformId, expectorId, acceptUserId, appointmentTime, 
	 * acceptTime, transactionId, schedule, device, 
	 * remarks, status, createTime, creatorId
	 */
	public Order copy(){
