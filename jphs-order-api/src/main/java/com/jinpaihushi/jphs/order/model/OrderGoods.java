...
public class OrderGoods extends BaseModel implements Predicate<OrderGoods>,
		Updator<OrderGoods> {
    ...
    public String toString() {
		return new StringBuilder().append("OrderGoods{").
			append("id=").append(id).
			...
			append(",expectorId=").append(expectorId).
			append(",executorId=").append(executorId).
    ...
    /**
	 * 复制字段：
	 * id, orderId, goodsId, title, 
	 * price, payPrice, profit, expectorId, 
	 * executorId, status, createTime, remark
	 */
