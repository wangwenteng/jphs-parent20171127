...
public  class AlipaySign {
	...
	public static void main(String[] args) {
		...
		byte[] s = getAlisign(sParaTemp.toString(),"PRIVATE_KEY");
	...
	public static byte[] getAlisign(String content,String registerDevice)  {
		...
		if(content==null ||"".equals(content)) {
			System.out.println("无效参数！content=="+content);
			return ReturnUtils.jsonReturnToString("0", "加密参数为空！","");
		}
		if(registerDevice==null ||"".equals(registerDevice)) {
			System.out.println("无效参数！registerDevice=="+registerDevice);
			return ReturnUtils.jsonReturnToString("0", "平台参数为空！","");
		}
		// 返回数据json字符串
		String signRe = "";
		// from表单
