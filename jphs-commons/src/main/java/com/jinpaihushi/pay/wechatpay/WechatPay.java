...
//			CREATE_IP = pps.getProperty("CREATE_IP");
			...
			if(APP_ID == null || "".equals(APP_ID)
					...
					|| CREATE_IP == null || NOTIFY_URL == null || "".equals(NOTIFY_URL)
		...
		try {
			...
			if(return_code != null && return_code != "" && !"".equals(return_code) 
					&& result_code != null && result_code != "" && !"".equals(result_code)
					&& result_code.equals("SUCCESS") && return_code.equals("SUCCESS") ){
