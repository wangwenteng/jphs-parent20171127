...
public class DoPostSms {
    ...
    public static void main(String[] args) {
        ...
        sendSms("13341181592", "【金牌护士】您的订单" + orderID + "支付成功。关注微信公众号“金牌护师”，时时查看订单状态。", "SMS_69255031",
                "{\"titles\":\"" + titles + "\",\"dbnames\":\"" + dbnames + "\"}");
    }
    ...
    public static String sendSms(String url, String userid, String account, String password, String mobile,
            ...
            String mobileNumber, String telephoneNumber, String sendType, String codingType) {
