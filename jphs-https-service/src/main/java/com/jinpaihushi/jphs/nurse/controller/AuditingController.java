...
public class AuditingController {
	...
	@Autowired
	private NurseImagesDao nureseImagesDao;
	@Autowired
	...
	public byte[] lookAudting(HttpServletRequest req, HttpServletResponse resp,String authCode,User user ,String nurseType){
		try{
			String token = "";
			try {
			...
			List<NurseJobtitle> nj = nurseJobtitleDao.getNurseAuditing(map);
	...
	@Transactional
	public byte[] audting(HttpServletRequest req, HttpServletResponse resp,String authCode,User user,String goodSkills,String skillsArr ,NurseJobtitle nurseJobtitle ){
		try{
			String token = "";
			try {
				token = req.getHeader("token");
