...
public class Goods extends BaseModel implements Predicate<Goods>,
		Updator<Goods> {
	 ...
	 * content, amount, profit, tijianTypeId, 
	 * tijianHospitalId, type, sort, remark, 
