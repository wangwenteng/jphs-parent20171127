 ...
 */
@SuppressWarnings("serial")
public class TijianHealthLog extends BaseModel implements Predicate<TijianHealthLog>,
		Updator<TijianHealthLog> {
    ...
    public String toString() {
		return new StringBuilder().append("TijianHealthLog{").
			append("id=").append(id).
			...
			append(",neck=").append(neck).
			append(",arm=").append(arm).
			append(",leg=").append(leg).
			append(",hand=").append(hand).
			append(",foot=").append(foot).
			append(",heart=").append(heart).
			append(",liver=").append(liver).
			append(",lungs=").append(lungs).
			append(",stomach=").append(stomach).
			append(",gallbladder=").append(gallbladder).
			append(",kidney=").append(kidney).
			append(",reproductivesystemMan=").append(reproductivesystemMan).
			append(",reproductivesystemWoman=").append(reproductivesystemWoman).
			append(",image=").append(image).
			append(",proposal=").append(proposal).
			append(",healthTime=").append(healthTime).
	...
	public boolean test(TijianHealthLog t) {
		...
		return (this.id == null || this.id.equals(t.id))
				...
				&& (this.tijianTypeId == null || this.tijianTypeId.equals(t.tijianTypeId))
				&& (this.head == null || this.head.equals(t.head))
				&& (this.neck == null || this.neck.equals(t.neck))
				&& (this.arm == null || this.arm.equals(t.arm))
				&& (this.leg == null || this.leg.equals(t.leg))
				&& (this.hand == null || this.hand.equals(t.hand))
				&& (this.foot == null || this.foot.equals(t.foot))
				&& (this.heart == null || this.heart.equals(t.heart))
				&& (this.liver == null || this.liver.equals(t.liver))
				&& (this.lungs == null || this.lungs.equals(t.lungs))
				&& (this.stomach == null || this.stomach.equals(t.stomach))
				...
				&& (this.kidney == null || this.kidney.equals(t.kidney))
				&& (this.reproductivesystemMan == null || this.reproductivesystemMan.equals(t.reproductivesystemMan))
				&& (this.reproductivesystemWoman == null || this.reproductivesystemWoman.equals(t.reproductivesystemWoman))
				&& (this.image == null || this.image.equals(t.image))
				&& (this.proposal == null || this.proposal.equals(t.proposal))
				&& (this.healthTime == null || this.healthTime.equals(t.healthTime))
				&& (this.notes == null || this.notes.equals(t.notes))
