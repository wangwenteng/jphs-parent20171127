...
public class PricePart extends BaseModel implements Predicate<PricePart>,
		Updator<PricePart> {
    ...
    public String toString() {
		return new StringBuilder().append("PricePart{").
			append("id=").append(id).
			...
			append(",aptitudeIdArr=").append(aptitudeIdArr).
	 ...
	 * oldPrice, costPrice, profit, status, 
	 * aptitudeIdArr, creatorId, creatorName, createTime
	 */
	public PricePart copy(){
		PricePart pricePart = new PricePart();
     	...
     	pricePart.aptitudeIdArr = this.aptitudeIdArr;
	...
	public boolean test(PricePart t) {
		...
		return (this.id == null || this.id.equals(t.id))
				...
				&& (this.aptitudeIdArr == null || this.aptitudeIdArr.equals(t.aptitudeIdArr))
	...
	public void update(PricePart element) {
		...
		if (this.aptitudeIdArr != null && !this.aptitudeIdArr.isEmpty()) {
			element.aptitudeIdArr = this.aptitudeIdArr;
		}
