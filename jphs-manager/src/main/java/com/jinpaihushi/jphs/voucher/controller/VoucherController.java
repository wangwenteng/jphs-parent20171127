...
public class VoucherController extends BaseController<Voucher> {
	...
	@RequestMapping(name = "添加或修改数据", path = "/insert.jhtml")
	public String insert(HttpSession hs, HttpServletRequest req, HttpServletResponse resp, ModelMap modelMap, Voucher voucher,Integer count,Double CAmount,Double DAmount) {
	...
	@RequestMapping(name = "查询用户", path = "/getUserList.jhtml") 
	public ModelMap getGoodsList(HttpSession hs, HttpServletRequest req, HttpServletResponse resp, ModelMap modelMap,User user, Integer p, Integer n) {
		user.setStatus(0);
		user.setType(1);
	...
	@RequestMapping(name = "添加优惠券使用", path = "/addVoucherUser.jhtml")
	@ResponseBody
	public JSONObject addVoucherUser(HttpSession hs, HttpServletRequest req, HttpServletResponse resp, ModelMap modelMap,VoucherUse voucherUse) {
	...
	@RequestMapping(name = "跳转到添加页", path = "/addUser.jhtml")
	public String addUser(HttpSession hs, HttpServletRequest req, HttpServletResponse resp,ModelMap modelMap,VoucherRepertory voucherRepertory,User user, Integer p, Integer n) {
