 ...
 */
@Controller
@RequestMapping(name = "CustomService", path = "/custom/service")
public class CustomServiceController extends BaseController<CustomService> {
	...
	public String insert(HttpSession hs, HttpServletRequest req, HttpServletResponse resp, ModelMap modelMap, CustomService customService) {
