 ...
 */
@Controller
@RequestMapping(name = "OrderOther", path = "/order/other")
public class OrderOtherController extends BaseController<OrderOther> {
	...
	public String insert(HttpSession hs, HttpServletRequest req, HttpServletResponse resp, ModelMap modelMap, OrderOther orderOther) {
