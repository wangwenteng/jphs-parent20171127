 ...
 */
@Controller
@RequestMapping(name = "OrderGoods", path = "/order/goods")
public class OrderGoodsController extends BaseController<OrderGoods> {
	...
	public String insert(HttpSession hs, HttpServletRequest req, HttpServletResponse resp, ModelMap modelMap, OrderGoods orderGoods) {
