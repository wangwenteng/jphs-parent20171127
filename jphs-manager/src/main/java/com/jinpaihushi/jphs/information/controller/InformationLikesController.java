 ...
 */
@Controller
@RequestMapping(name = "InformationLikes", path = "/information/likes")
public class InformationLikesController extends BaseController<InformationLikes> {
	...
	public String insert(HttpSession hs, HttpServletRequest req, HttpServletResponse resp, ModelMap modelMap, InformationLikes informationLikes) {
