 ...
 */
@Controller
@RequestMapping(name = "InformationCollection", path = "/information/collection")
public class InformationCollectionController extends BaseController<InformationCollection> {
	...
	public String insert(HttpSession hs, HttpServletRequest req, HttpServletResponse resp, ModelMap modelMap, InformationCollection informationCollection) {
