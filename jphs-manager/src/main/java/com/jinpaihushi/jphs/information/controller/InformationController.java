 ...
 */
@Controller
@RequestMapping(name = "Information", path = "/information")
public class InformationController extends BaseController<Information> {
	...
	public String insert(HttpSession hs, HttpServletRequest req, HttpServletResponse resp, ModelMap modelMap, Information information,String topTimet) {
	...
	public String delete(HttpSession hs, HttpServletRequest req, HttpServletResponse resp, ModelMap modelMap,Information information) {
		boolean b = informationService.update(information);
		if (b == false) {
			// 跳转到错误页
			return "redirect:/information/err.jhtml";
