 ...
 */
@Controller
@RequestMapping(name = "UserAddress", path = "/user/address")
public class UserAddressController extends BaseController<UserAddress> {
	...
	public String insert(HttpSession hs, HttpServletRequest req, HttpServletResponse resp, ModelMap modelMap, UserAddress userAddress) {
