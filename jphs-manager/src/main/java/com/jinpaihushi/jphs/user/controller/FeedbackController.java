 ...
 */
@Controller
@RequestMapping(name = "Feedback", path = "/feedback")
public class FeedbackController extends BaseController<Feedback> {
	...
	public String insert(HttpSession hs, HttpServletRequest req, HttpServletResponse resp, ModelMap modelMap, Feedback feedback) {
