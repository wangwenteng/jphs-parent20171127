...
<div style="margin: 10px 10px 10px 10px;">
	...
	<form class="add_body" id="aptitudeNurseForm" method="post" data-role="validate-form"
		action="/aptitude/nurse/insert.jhtml">
		<div class="tool_form">
			<div class="wf_btn_left">
				<afocus:privilege url="/aptitude/nurse/save.jhtml">
