...
<div class="common_right_title">
	<img src="/static/images/yousanjiaox.png" />职称管理<i class="public1-horn-45"></i>职称列表 
</div>
...
<div class="marage_right_content">
	<!-- 左对齐按钮 -->
	<button id="redirectAddPage" type="button" class="public-info public_btn">新建职称</button>
