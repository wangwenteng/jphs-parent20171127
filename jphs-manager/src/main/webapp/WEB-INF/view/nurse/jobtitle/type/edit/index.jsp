...
<div class="common_right_title">
	<img src="/static/images/yousanjiaox.png" />护士管理<i
		class="public1-horn-45"></i>职称类型管理<i class="public1-horn-45"></i>${jobtitleType.id == null?'职称类型添加':'职称类型编辑'}
</div>

<form class="form-horizontal edit_form" id="jobtitleTypeForm"
	method="post" data-role="validate-form"
	action="/jobtitle/type/insert.jhtml">
