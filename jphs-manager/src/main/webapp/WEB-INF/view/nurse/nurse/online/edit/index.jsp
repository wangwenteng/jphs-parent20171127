...
<div style="margin: 10px 10px 10px 10px;">
	...
	<form class="add_body" id="nurseOnlineForm" method="post" data-role="validate-form"
		action="/nurse/online/insert.jhtml">
		<div class="tool_form">
			<div class="wf_btn_left">
				<afocus:privilege url="/nurse/online/insert.jhtml">
