...
<div style="margin: 10px 10px 10px 10px;">
	...
	<form class="add_body" id="nurseImagesForm" method="post" data-role="validate-form"
		action="/nurse/images/insert.jhtml">
		<div class="tool_form">
			<div class="wf_btn_left">
				<afocus:privilege url="/nurse/images/save.jhtml">
