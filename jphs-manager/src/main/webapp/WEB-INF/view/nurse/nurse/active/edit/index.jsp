...
<div style="margin: 10px 10px 10px 10px;">
	...
	<form class="add_body" id="nurseActiveForm" method="post" data-role="validate-form"
		action="/nurse/active/insert.jhtml">
		<div class="tool_form">
			<div class="wf_btn_left">
				<afocus:privilege url="/nurse/active/save.jhtml">
