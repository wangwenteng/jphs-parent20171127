...
<div style="margin: 10px 10px 10px 10px;">
	...
	<form class="add_body" id="systemModuleForm" method="post" data-role="validate-form"
		action="/system/module/insert.jhtml">
		<div class="tool_form">
			<div class="wf_btn_left">
				<afocus:privilege url="/system/module/save.jhtml">
