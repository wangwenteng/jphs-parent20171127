...
<div class="common_right_title">
	<img src="/static/images/yousanjiaox.png" />系统管理 <i
		class="public1-horn-45"></i> 用户管理 <i class="public1-horn-45"></i>角色分配
</div>
<div class="marage_right_content">
	<form class="form-horizontal edit_form" id="systemUserRoleForm" method="post"
		data-role="validate-form" action="/system/user/saveRoles.jhtml">
		<div class="clearfix">
