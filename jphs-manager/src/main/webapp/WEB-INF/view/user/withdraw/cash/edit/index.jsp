...
<div style="margin: 10px 10px 10px 10px;">
	...
	<form class="add_body" id="withdrawCashForm" method="post" data-role="validate-form"
		action="/withdraw/cash/insert.jhtml">
		<div class="tool_form">
			<div class="wf_btn_left">
				<afocus:privilege url="/withdraw/cash/save.jhtml">
