...
<div class="common_right_title">
	<img src="/static/images/yousanjiaox.png" />产品管理<i class="public1-horn-45"></i>商品管理 <i class="public1-horn-45"></i>商品管理 <i class="public1-horn-45"></i>${goods.id == null?'添加商品':'编辑商品'}
</div>
