...
<div style="margin: 10px 10px 10px 10px;">
	...
	<form class="add_body" id="customServiceForm" method="post" data-role="validate-form"
		action="/custom/service/insert.jhtml">
		<div class="tool_form">
			<div class="wf_btn_left">
				<afocus:privilege url="/custom/service/save.jhtml">
