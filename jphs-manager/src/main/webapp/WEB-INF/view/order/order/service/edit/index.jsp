...
<div style="margin: 10px 10px 10px 10px;">
	...
	<form class="add_body" id="orderServiceForm" method="post" data-role="validate-form"
		action="/order/service/insert.jhtml">
		<div class="tool_form">
			<div class="wf_btn_left">
				<afocus:privilege url="/order/service/save.jhtml">
