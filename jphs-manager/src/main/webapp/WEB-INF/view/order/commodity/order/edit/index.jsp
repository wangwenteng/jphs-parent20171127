...
<div style="margin: 10px 10px 10px 10px;">
	...
	<form class="add_body" id="commodityOrderForm" method="post" data-role="validate-form"
		action="/commodity/order/insert.jhtml">
		<div class="tool_form">
			<div class="wf_btn_left">
				<afocus:privilege url="/commodity/order/save.jhtml">
