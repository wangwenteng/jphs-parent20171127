...
<div style="margin: 10px 10px 10px 10px;">
	...
	<form class="add_body" id="voucherRepertoryForm" method="post" data-role="validate-form"
		action="/voucher/repertory/insert.jhtml">
		<div class="tool_form">
			<div class="wf_btn_left">
				<afocus:privilege url="/voucher/repertory/save.jhtml">
