package com.jinpaihushi.jphs.wecth.model;
...
public class Wecth extends BaseModel implements Predicate<Wecth>,
		Updator<Wecth> {
	...
	@Override
	public void update(Wecth element) {
		if (element == null)
			return;
