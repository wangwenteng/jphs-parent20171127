 ...
 */
@SuppressWarnings("serial")
public class HealthLog extends BaseModel implements Predicate<HealthLog>,
		Updator<HealthLog> {
    ...
    public String toString() {
		return new StringBuilder().append("HealthLog{").
			append("id=").append(id).
			append(",type=").append(type).
			append(",userId=").append(userId).
			append(",orderId=").append(orderId).
			append(",advise=").append(advise).
			append(",evaluateContent=").append(evaluateContent).
			append(",diseaseCauses=").append(diseaseCauses).
			append(",physicalSymptoms=").append(physicalSymptoms).
			append(",presentIllness=").append(presentIllness).
			append(",diseasesHistory=").append(diseasesHistory).
			append(",medicationRemind=").append(medicationRemind).
