...
public class NurseRank extends BaseModel implements Predicate<NurseRank>,
		Updator<NurseRank> {
    ...
    public String toString() {
		return new StringBuilder().append("NurseRank{").
			append("id=").append(id).
			append(",userId=").append(userId).
			append(",ranking=").append(ranking).
			append(",type=").append(type).
			append(",baseServerNumber=").append(baseServerNumber).
			append(",realServerNumer=").append(realServerNumer).
			append(",favorableRate=").append(favorableRate).
			append(",degreeHeat=").append(degreeHeat).
